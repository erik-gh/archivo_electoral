...
<div class="site-main">
    ...
    <div class="site-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <div class="panel panel-default panel-table m-b-0">
                                            ...
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <div id="tbl_consulta" class="dataTables_wrapper form-inline"
                                                         role="grid">
                                                        <table id="tableConsultas"
                                                            ...
                                                            <tr class="bg-primary">
                                                                ...
                                                                <th class="text-center" width="30%">DESCRIPCI&Oacute;N
                                                                </th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <div class="panel panel-default panel-table m-b-0">
                                            ...
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <div id="tbl_solucion" class="dataTables_wrapper form-inline"
                                                         role="grid">
                                                        <table id="tableSoluciones"
                                                               class="display table table-bordered table-hover"
                                                               cellspacing="0" width="100%">
                                                            <thead class="text-center font-table">
                                                            <tr class="bg-primary">
                                                                <th class="text-center" width="5%">Nº</th>
                                                                <th class="text-center" width="10%">SOLUCION
                                                                    TECNOLOGICA
                                                                </th>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <form class="form" id="form_registerIncidencia" method="POST"
                                                            ...
                                                            <input class="form-control" type="hidden"
                                                                   id="txtIDIncidencia" name="txtIDIncidencia">
                                                            <input class="form-control" type="hidden"
                                                                   id="txtcontrolIncidencia" name="txtcontrolIncidencia"
                                                                   value="0">
                                                            <div class="panel panel-default">
                                                                <div class="panel-body">
                                                                    <div class="row">
                                                                    ...
                                                                    <div class="row" id="estado_incidencia"
                                                                         style="display: none;">
                                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                            <div class="switches-stacked">
                                                                                <label>Activo</label>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="tab-dispositivo">
                                <div class="row">
                                                        ...
                                                        <form class="form" id="form_registerDispositivo" method="POST" autocomplete="off" action="javascript:void(0);">
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel-body">
                                                                    ...
                                                                    <div class="row" id="estado_dispositivo"
                                                                         style="display: none;">
                                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                                            <div class="switches-stacked">
                                                                                <label>Activo</label>
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <div class="panel panel-default panel-table m-b-0">
                                            <div class="panel-heading">
                                                <h4 class="text-center text-primary font-12"><strong>LISTA DE SOBRES</strong></h4>
                                            </div>
                                            <div class="panel-body">
                                                <div class="table-responsive">
        ...
        <!-- Modal ETAPA -->
        <div class="modal fade" id="modal_etapa" role="dialog" data-keyboard="false" data-backdrop="static"
             tabindex="-1">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-lg-10">
                            <form class="form-horizontal" id="form_registerEtapa" method="POST" autocomplete="off">
                                ...
                                <input class="form-control" type="hidden" id="txtcontrolEtapa" name="txtcontrolEtapa"
                                       value="0">
                                <div class="panel ">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <label>Etapa</label>
                                                    <div class="input-group-prepend">
                                                        <input type="text" class="form-control vld" name="txtetapa"
                                                               id="txtetapa" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <label>Descripci&oacute;n</label>
                                                    <div class="input-group-prepend">
                                                        <input type="text" class="form-control vld"
                                                               name="txtdescripcionEtapa" id="txtdescripcionEtapa"
                                                               required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <div class="switches-stacked">
                                                        <label>Activo</label>
                                                        <label class="switch switch-primary">
                                                            <input type="checkbox" id="chkestadoEtapa"
                                                                   name="chkestadoEtapa" class="s-input">
                                                            <span class="s-content">
                                    <span class="s-track"></span>
                                    <span class="s-handle"></span>
                                  </span>
                                        ...
                                        <div class="row clearfix m-t-30">
                                            <div class="pull-right">
                                                <button type="submit" class="btn btn-outline-primary" id="updateEtapa">
                                                    <i class="zmdi zmdi-refresh zmdi-hc-fw m-r-5"></i><span>Actualizar</span>
                                                </button>
                                                <a class="btn btn-outline-danger" data-dismiss="modal" id="cancelEtapa"
                                                   onclick="cancelEtapa();"><i
                                                            class="zmdi zmdi-close zmdi-hc-fw m-r-5"></i><span>Cerrar</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <!-- Modal MATERIAL -->
        <div class="modal fade" id="modal_material" role="dialog" data-keyboard="false" data-backdrop="static"
             tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-lg-10">
                            <form class="form-horizontal" id="form_registerMaterial" method="POST" autocomplete="off">
                                ...
                                <input class="form-control" type="hidden" id="txtcontrolMaterial"
                                       name="txtcontrolMaterial" value="0">
                                <div class="panel ">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <input type="text" class="form-control vld" name="txtmaterial"
                                                               id="txtmaterial" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <input type="text" class="form-control vld"
                                                               name="txtdescripcionMaterial" id="txtdescripcionMaterial"
                                                               required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <div class="switches-stacked">
                                                        <label>Activo</label>
                                                        <label class="switch switch-primary">
                                                            <input type="checkbox" id="chkestadoMaterial"
                                                                   name="chkestadoMaterial" class="s-input">
                                                            <span class="s-content">
                                    <span class="s-track"></span>
                                    <span class="s-handle"></span>
                                  </span>
                                        ...
                                        <div class="row clearfix m-t-30">
                                            <div class="pull-right">
                                                ...
                                                <a class="btn btn-outline-danger" data-dismiss="modal"
                                                   id="cancelMaterial" onclick="cancelMaterial();"><i
                                                            class="zmdi zmdi-close zmdi-hc-fw m-r-5"></i><span>Cerrar</span></a>
                                            </div>
                                        </div>
                                    </div>
