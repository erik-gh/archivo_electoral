                                              ...
                                              <div class="panel-body">                                        
                                                <div class="table-responsive">
                                                  <div id="tbl_cargaAvance" class="dataTables_wrapper form-inline" role="grid">
                                                    ...
                                                    <div class="clearfix">
                                                      <div class="pull-left">
                                                        <a href="#" class="btn btn-success text-right" onclick="exportarReporteGeneral();"><i class="zmdi zmdi-download zmdi-hc-fw m-r-5"></i><span>DESCARGAR</span></a><br><br>
                                                      </div>
                                                      <div class="pull-right">
                                          ...
                                          <div class="panel-body">                                        
                                            <div class="table-responsive">
                                              <div id="tbl_cargaOdpe" class="dataTables_wrapper form-inline" role="grid">
                                                    ...
                                                    <div class="clearfix">
                                                      <div class="pull-left">
                                                        <a href="#" class="btn btn-success text-right" onclick="exportarReporteOdpe();"><i class="zmdi zmdi-download zmdi-hc-fw m-r-5"></i><span>DESCARGAR</span></a><br><br>
                                                      </div>
                                                      <!-- <div class="pull-right">
                                                        <a class="btn btn-black" id="verGrafico" onclick="verGraficaOdpe()"><i class="zmdi zmdi-apps zmdi-hc-fw m-r-5"></i><span> VER GRAFICO ODPE </span></a> 
                                                      </div> -->
                                            ...
                                            <div class="table-responsive">
                                              <div id="tbl_cargaUsuarioMesa" class="dataTables_wrapper form-inline" role="grid">
                                                  <h4 class="text-center text-danger" id="titleUsuarioMesa"></h4>
                                                    <div class="clearfix">
                                                      <div class="pull-left">
                                                        <a href="#" class="btn btn-success text-right" onclick="exportarReporteUsuarioMesa();"><i class="zmdi zmdi-download zmdi-hc-fw m-r-5"></i><span>DESCARGAR</span></a><br><br>
                                                      </div>
                                                      <!-- <div class="pull-right">
                                                        <a class="btn btn-black" id="verGrafico" onclick="verGraficaOdpe()"><i class="zmdi zmdi-apps zmdi-hc-fw m-r-5"></i><span> VER GRAFICO ODPE </span></a> 
                                                      </div> -->
                            ...
                            <div class="row">
                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group text-center">
                                  <span class="font-24 text-blue-grey" id="txtMesa"></span>
                                </div>
                              </div>
                            </div>
                            <div class="row">
